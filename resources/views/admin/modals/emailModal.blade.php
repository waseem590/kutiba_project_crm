<!-- mail model -->
<div class="modal social-custom-modals fade" id="mail-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            <div>
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control" id="usr" placeholder="Ronny@gmail.com">
                  </div>
