@extends('admin.master') @section('content')
    ...
    <div class="add-students-section">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                    <span>
                        <img src="{{ asset('admin/images/add-student-logo.png') }}" alt="add-student-logo"
                            class="img-fluid" />
                    </span>
                    Add Student
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link tab2" href="#tabs-2" role="tab">
                    <span><img src="{{ asset('admin/images/student-info.png') }}" alt="student-info"
                            class="img-fluid" /></span>
                    Student Information</a>
            </li>
            <li class="nav-item">
                <a class="nav-link tab3" href="#tabs-3" role="tab">
                    <span><img src="{{ asset('admin/images/contact-detail.png') }}" alt="contact-detail"
                            class="img-fluid" /></span>
                    Contact Detail</a>
            </li>
            <li class="nav-item">
                <a class="nav-link tab4" href="#tabs-4" role="tab">
                    <span><img src="{{ asset('admin/images/other-info.png') }}" alt="other-detail"
                            class="img-fluid" /></span>
                    Other Information</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                <form id="add_student_form" method="post" action="{{ route('student.store') }}">
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label for="exampleFormControlSelect1" class="tab-inner-label">Office<span
                                    style="color:red">*</span></label>
                            <select class="form-control select-inner-text office" id="exampleFormControlSelect1"
                                name="office">
                                ...
                                @if (!empty($dropdown[0]->dropdownType))
                                    @foreach ($dropdown[0]->dropdownType as $val)
                                        <option value="{{ $val->id }}"
                                            @if (isset($user->office) && $user->office == $val->id) ? selected @endif>{{ $val->name }}</option>
                                    @endforeach
                                @endif
                            </select>

                            <input type="hidden" class="forEdit" value="{{ $forEdit ?? '' }}" />
                            <input type="hidden" class="addStudent_id" name="addStudent_id"
                                value="{{ $user->id ?? '' }}" />
                        ...
                        <div class="form-group col-md-4">
                            <label for="exampleFormControlSelect2" class="tab-inner-label">Counsellor<span
                                    style="color:red">*</span></label>
                            <select class="form-control select-inner-text counsellor" id="exampleFormControlSelect1"
                                name="counsellor">
                                <option disabled selected value>
                                    Select Counsellor
                                </option>
                                @foreach ($counsellor as $val)
                                    <option value="{{ $val->id }}"
                                        @if (isset($user->counsellor) && $user->counsellor == $val->id) ? selected @endif>{{ $val->name }}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-4 mb-0">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Admission Officer<span
                                    style="color:red">*</span></label>
                            <select
                                class="
                                form-control
                                ...
                                admission_officer
                            "
                                id="exampleFormControlSelect1" name="admission_officer" value="{{ old('event_name') }}">
                                <option disabled selected value>
                                    Select Admission Officer
                                </option>
                                @foreach ($admission_officer as $val)
                                    <option value="{{ $val->id }}"
                                        @if (isset($user->admission_officer) && $user->admission_officer == $val->id) ? selected @endif>{{ $val->name }}</option>
                                @endforeach
                            </select>
                            <span class="invalid-feedback">
                                <p></p>
                ...
                <form id="student_information_form">
                    <div class="form-row">
                        ...
                        <div class="col-md-4 col-md-4">
                            ...
                            <input type="date" class="form-control select-inner-text" name="dob"
                                value="{{ $user->info->dob ?? '' }}" />
                            <span class="invalid-feedback">
                                <p></p>
                            </span>
                        ...
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Gender<span
                                    style="color:red">*</span></label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1" name="gender">
                                <option disabled selected value>Select</option>
                                <option value="Male" @if (isset($user->info->gender) && $user->info->gender === 'Male') ? selected : 'Male' @endif>Male
                                </option>
                                <option value="Female" @if (isset($user->info->gender) && $user->info->gender === 'Female') ? selected : 'Female' @endif>
                                    Female</option>
                                <option value="Other"
                                    @if (isset($user->info->gender) && $user->info->gender === 'Other') ? selected : 'Saudi Arabia' @endif>Other</option>
                            </select>
                            <span class="invalid-feedback">
                                <p></p>
                            </span>
                        ...
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Nationality<span
                                    style="color:red">*</span></label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1"
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}"
                                        @if (isset($user->info->nationality) && $user->info->nationality == $country->id) ? selected @endif>{{ $country->name }}</option>
                                @endforeach
                        ...
                        <div class="form-group col-md-4">
                            <div class="position-relative1 form-check-inline">
                                ...
                                <div class="student-radio">
                                    <span>
                                        <input type="radio" id="test1" name="visa" value="yes"
                                    ...
                                    <span>
                                        <input type="radio" id="test2" name="visa" value="no"
                        ...
                        <div class="form-group col-md-12 student-note">
                            ...
                            <textarea placeholder="" class="form-control" name="note">{{ $user->info->note ?? '' }}</textarea>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between student-form-action">
                        ...
                        <button type="submit" id="student_information_btn" class="btn">
                            Next
                        </button>
                    </div>
                </form>
            ...
            <div class="tab-pane" id="tabs-3" role="tabpanel">
                <form id="contact_detail_form">
                    <div class="form-row">
                        <div class="col-md-4 col-md-4">
                            <label class="tab-inner-label" for="">Email address<span
                                    style="color:red">*</span></label>
                            <input type="email" class="form-control select-inner-text" placeholder="" name="email"
                        ...
                        <div class="col-md-4 col-md-4">
                            <label class="tab-inner-label" for="">Secondary email address</label>
                            <input type="email" class="form-control select-inner-text" placeholder=""
                                name="secondary_email" value="{{ $user->contact->secondary_email ?? '' }}" />
                        </div>
                        <div class="col-md-4 col-md-4 mm_country">
                            ...
                            /> -->
                            <input class="form-control" value="{{ $user->contact->contact_number ?? '' }}"
                                type="tel" name="phone_number[main]" id="phone_number" />
                        ...
                        <div class="col-md-4 col-md-4 mt-3  mm_contact2">
                            ...
                            /> -->
                            <input class="form-control" value="{{ $user->contact->secondary_contact_number ?? '' }}"
                                type="tel" name="phone_number2[main]" id="phone_number2" />
                        </div>

                        <div class="form-group col-md-12 mt-3">
                            <div class="position-relative1 form-check-inline">
                                <p for="exampleFormControlSelect3" class="tab-inner-label w-100">
                                    Address details
                                </p>

                                <div class="student-radio">
                                    <span>
                                        <input type="radio" id="test3" name="address_details" value="offshore"
                                    ...
                                    <span>
                                        <input type="radio" id="test4" name="address_details" value="onshore"
                        ...
                        <div class="col-md-4 col-md-4 mt-3">
                            ...
                            <input type="text" class="form-control select-inner-text" placeholder=""
                                name="street_address" value="{{ $user->contact->street_address ?? '' }}" />
                            <span class="invalid-feedback">
                                <p></p>
                            </span>
                        </div>
                        ...
                        <div class="col-md-4 col-md-4 mt-3">
                            ...
                            <input type="text" class="form-control select-inner-text" placeholder="" name="suburb"
                        ...
                        <div class="col-md-4 col-md-4 mt-3">
                            ...
                            <input type="text" class="form-control select-inner-text" placeholder="" name="state"
                        ...
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Country<span
                                    style="color:red">*</span></label>
                            <select class="form-control select-inner-text" id="personlist" name="country">
                                <option disabled="" selected value="">Select Country</option>
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}"
                                        @if (isset($user->contact->country) && $user->contact->country == $country->id) ? selected @endif>{{ $country->name }}</option>
                                @endforeach
                        ...
                        <div class="col-md-4 col-md-4 mt-3">
                            ...
                            <input type="number" class="form-control select-inner-text" placeholder="" name="post_code"
            ...
            <div class="tab-pane" id="tabs-4" role="tabpanel">
                <form id="other_information_form">
                    <div class="form-row">
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3"
                                class="tab-inner-label">{{ $dropdown[1]->name }}</label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1"
                                name="funding_type">
                                ...
                                @if (!empty($dropdown[1]->dropdownType))
                                    @foreach ($dropdown[1]->dropdownType as $val)
                                        <option value="{{ $val->id }}"
                                            @if (isset($user->otherInfo->funding_type) && $user->otherInfo->funding_type == $val->id) ? selected @endif>{{ $val->name }}
                                        </option>
                                    @endforeach
                                @endif
                        ...
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3"
                                class="tab-inner-label">{{ $dropdown[2]->name }}</label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1"
                                name="sponsor_name">
                                ...
                                @if (!empty($dropdown[2]->dropdownType))
                                    @foreach ($dropdown[2]->dropdownType as $val)
                                        <option value="{{ $val->id }}"
                                            @if (isset($user->otherInfo->sponsor_name) && $user->otherInfo->sponsor_name == $val->id) ? selected @endif>{{ $val->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-md-4 mt-3">
                            <label for="exampleFormControlSelect3"
                                class="tab-inner-label">{{ $dropdown[3]->name }}</label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1"
                                name="student_source">
                                ...
                                @if (!empty($dropdown[3]->dropdownType))
                                    @foreach ($dropdown[3]->dropdownType as $val)
                                        <option value="{{ $val->id }}"
                                            @if (isset($user->otherInfo->student_source) && $user->otherInfo->student_source == $val->id) ? selected @endif>{{ $val->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                        ...
                        <div class="form-group col-md-12 mt-3" style="margin-bottom:-21px">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Cohort?</label>

                            <div class="form-group-custom">
                                <input type="checkbox" class="cohort_checkbox" id="html" name="cohort"
                                    @if (isset($user->otherInfo->cohort_name) && $user->otherInfo->cohort_name != 'Null') ? checked : '' @endif />
                                <label for="html">Yes</label>
                            </div>
                        </div>

                        <div class="form-group col-md-4 mt-3 cohort_input no_display">
                            <label for="exampleFormControlSelect3" class="tab-inner-label">Name of cohort</label>
                            <select class="form-control select-inner-text" id="exampleFormControlSelect1"
                                name="cohort_name">
                                ...
                                @if (!empty($dropdown[4]->dropdownType))
                                    @foreach ($dropdown[4]->dropdownType as $val)
                                        <option value="{{ $val->id }}"
                                            @if (isset($user->otherInfo->cohort_name) && $user->otherInfo->cohort_name == $val->id) ? selected @endif>{{ $val->name }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                    ...
                    <div class="d-flex justify-content-between student-form-action">
                        ...
                        <button type="submit" id="other_information_btn" class="btn">
                            Submit
                        </button>
                    </div>
                </form>
    ...
    <script>
        ...
        $(document).on("click", "#contact_detail_btn", function(e) {
            ...
            $.ajax({
                data: $("#contact_detail_form").serialize() +
                    "&forEdit=" +
                    $(".forEdit").val(),
        ...
        $(document).on("click", "#other_information_btn", function(e) {
            ...
            $.ajax({
                data: $("#other_information_form").serialize() +
                    "&forEdit=" +
                    $(".forEdit").val(),
