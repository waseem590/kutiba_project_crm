...
@section('content')
    <div class="students-List-section">
        ...
        <button class="std-detail_btns white-bg" id="advanceSearchBtn" data-toggle="modal" data-target="#form"><i
                ...
                <tbody id="student_filter_table">
                    ...
                    @foreach ($add_students as $key => $item)
                        ...
                        <tr>
                            ...
                            <td> {{ $surname[0] ?? '' }} </td>
                            <td class="text-nowrap"><a href="{{ route('student.show', $item->id) }}">{{ $name[0] ?? '' }}
                                    {{ $name[1] ?? '' }}</a></td>
