                ...
                <div class="student-card bg-white mm-dsahboard-set">
                            ...
                            @if($latest_students)   
                                ...
                                <tr>
                                    ...
                                    @if($student->mark == "Complete")
                                        <input type="checkbox" checked data-toggle="toggle" id="complete_stu"  data-on="Complete" data-off="Incomplete" class="complete_status custom-switch-lg complete1" data-id="{{$student->id}}" data-onstyle="success" data-offstyle="danger"   >
                                    @else
                                    <input type="checkbox" checked data-toggle="toggle" id="complete_stu"  data-on="Complete" data-off="Incomplete" class="complete_status custom-switch-lg complete" data-id="{{$student->id}}" data-onstyle="success" data-offstyle="danger"   >
                                    @endif
                                    ...
                                    <td>{{$student->student_applications->first()->status}}</td>
                                    @else
                                    <td>Not Available</td>
                                    @endif
                                </tr>
                    ...
                    <div class="row" style="padding-top: 8px;">
                        <div class="col-sm-12 text-right">
                            <a class="btn edit_save float-right px-3 py-1" style="padding-top: 7px !important;" href="{{ route('studentlists') }}">View All
                                Students</a>
                        </div>
                    </div>
                ...
                <div class="modal-body" >
                    ...
                    <div class="col-12 birthday">
                        <div class="card">
                            ...
                            <img src="{{ asset('admin/images/'.$staff->profile_photo)}}" alt="staff_image" height="100px" width="100px" style="border-radius:50%">
                            <h4 style="color:black; text-transform: capitalize;">{{$staff->name ?? ''}}</h4>    
                            <h6 style="color:black; text-transform: capitalize;">{{$staff->role ?? ''}}</h6>    
...
<script type="text/javascript">
    ...
    calendarr.attachTo(document.getElementById('calendarr'));
