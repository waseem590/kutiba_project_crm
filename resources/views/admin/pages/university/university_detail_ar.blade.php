...
<div class="add-students-section">
    <div class="list-std-btns d-flex justify-content-between mr-3" dir="rtl">
    <h1 class="page-heading d-flex mr-5" dir="rtl">{{__('translation.Knowledge_Center')}}</h1>
        <a href="{{ url()->previous() }}"><i class="fas fa-step-backward"></i> &nbsp; {{__('translation.back')}}</a>
    </div>
    ...
    <div class="knowledge-center-wrapper">
        ...
        <div class="knowledge-detail-content" dir="rtl" style="text-align:right">
            <div class="detail-top-div">
                <h1>{{$university->ar_title}}</h1>
                <div class="konowldege-top-social">
                    <a href="{{URL::to($university['doc_file'])}}" download="{{$university['ar_title']}}"><img
                            src="{{asset('images/word-file-icon.png')}}" alt="word-file-icon"></a>
                    <a href="{{URL::to($university['exl_file'])}}" download="{{$university['ar_title']}}"><img
                            src="{{asset('images/xcel-icon.png')}}" alt="xcel-icon"></a>
                    <a href="{{URL::to($university['ppt_file'])}}" download="{{$university['ar_title']}}"><img
                            src="{{asset('images/powerpoint-icon.png')}}" alt="powerpoint-icon"></a>
                </div>
            </div>
            <div class="text-justify">
                {!! $university->arabic_summernote !!}
            </div>
            <div>
                <a href="/guidelines/language/ar/1" class="knowledge-more ">{{__('translation.back')}}</a>
            </div>
        </div>
    </div>
