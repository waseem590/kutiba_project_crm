        ...
        <div class="mm-add-std-top-social">
            ...
            <div class="list-std-btns">
                ...
                <a class="del-bg" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#deleteModal"
                    onclick="deleteRecord({{ $applications->id }},'/users/delete_application/')"><i
                ...
                <div class="col-md-12 border-bottom">
                    <div class="row">
                        @if ($applications->duration)
                            ...
                            <div class="col-3  col-lg-3 col-xl-2 border-right">
                                <p>Yes</p>
                            </div>
                            <div class="col-3 col-lg-3 col-xl-2">
                                <h3>Duration:</h3>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="row">
                                @if (!empty($applications->special_education->foundation))
                                    ...
                                    <div class="col-6  col-xl-8">
                                        <p>{{ date('M d, Y', strtotime($applications->special_education->foundation ?? '')) }}
                                        </p>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->d_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (!empty($applications->education->advance_diploma))
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->ad_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (!empty($applications->education->bachelor))
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->b_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (!empty($applications->education->bachelor_hons))
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->bh_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 col-lg-6">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-lg-6">
                                            <p>{{ date('M d, Y', strtotime($applications->education->gd_start_date ?? '')) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if (!empty($applications->education->masters_degree))
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->md_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        @if (!empty($applications->education->doctoral_degree))
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-6">
                                        <p>{{ date('M d, Y', strtotime($applications->education->dd_start_date ?? '')) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="row">
                                @if (!empty($applications->education->primary_school))
                                    ...
                                    <div class="col-6  col-xl-8">
                                        <p>{{ date('M d, Y', strtotime($applications->education->primary_school ?? '')) }}
                                        </p>
                                    </div>
                                @endif
                            </div>
