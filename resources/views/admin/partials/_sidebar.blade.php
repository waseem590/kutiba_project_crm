<div id="sidebar-wrapper">
    <ul class="sidebar-nav ">
            ...
            <div class="col-12">
                <div class="text-center md-my-4 mt-4">
                    <a href="{{route('profile')}}"><span class="side-profile">
                            <img class="img-fluid dashboard-icon-border" src="{{ asset('admin/images/'.Auth::user()->profile_photo )}}" alt="" />
                        </span></a>
                </div>
            </div>
        </div>
        ...
        <li class="nav-item stu-dropdown">
            <a class="collapsed text-truncate students_click" href="#students_submenue" data-toggle="collapse" data-target="#students_submenue">
                <!-- <img src="{{ asset('admin/images/02.png')}}" alt="image" /> -->
                <i class="fas fa-user-graduate bulk-mail"></i>
                <span class="d-none d-sm-inline pl-2 mm-gudeline">Students</span> <i class="fas fa-angle-down arrow_style"></i>
            </a>
        ...
        <li class="nav-item stu-dropdown">
            <a class="collapsed text-truncate" href="#visa_submenue" data-toggle="collapse" data-target="#visa_submenue">
                <img src="{{ asset('admin/images/02.png')}}" alt="image" />
                <!-- <i class="fab fa-cc-visa"></i> -->
                <span class="d-none d-sm-inline pl-2 mm-gudeline">Visa</span> <i class="fas fa-angle-down arrow_style"></i></a>
        ...
        <!-- new collapse  -->
        <li class="nav-item stu-dropdown">
            <a class="collapsed text-truncate" href="#users-submenus" data-toggle="collapse" data-target="#users-submenus">
                <!-- <img src="{{ asset('admin/images/02.png')}}" alt="image" /> -->
                <i class="fas  fa-users bulk-mail"></i>
                <span class="d-none d-sm-inline pl-2 mm-gudeline">Users</span> <i class="fas fa-angle-down arrow_style"></i>
            </a>
        ...
        <li class="nav-item stu-dropdown mm-knowlidge">
            <a class="nav-link collapsed text-truncate" href="#guidlines_submenue" data-toggle="collapse" data-target="#guidlines_submenue">
                <img src="{{ asset('admin/images/04.png')}}" alt="image" />
                <span class="d-none d-sm-inline pl-2 mm-gudeline">Guidelines</span> <i class="fas fa-angle-down arrow_style"></i></a>
