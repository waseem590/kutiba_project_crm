                  ...
                  <td>
                    ...
                    <td class="custem-text-center std-list-icon">
                        ...
                        @if($item->mark == "Complete")
                                        <input type="checkbox" checked data-toggle="toggle" id="complete_stu"  data-on="Complete" data-off="Incomplete" class="complete_status custom-switch-lg complete1" data-id="{{$item->id}}" data-onstyle="success" data-offstyle="danger"   >
                                    @else
                                    <input type="checkbox" checked data-toggle="toggle" id="complete_stu"  data-on="Complete" data-off="Incomplete" class="complete_status custom-switch-lg complete" data-id="{{$item->id}}" data-onstyle="success" data-offstyle="danger"   >
                                    @endif
                    </td>
                </tr>
                @endforeach
